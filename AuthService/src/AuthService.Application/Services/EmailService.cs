...
public class EmailService(IConfiguration configuration, ILogger<EmailService> logger) : IEmailService
{
    ...
    {
        var subject = "Welcome to AdminEvents!";

        var body = $@"
        <h2>Welcome to AdminEvents, {username}!</h2>
    ...
    private async Task SendEmailAsync(string to, string subject, string body)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                message.From.Add(new MailboxAddress(fromName ?? "AdminEvents Auth", fromEmail ?? "noreply@adminevents.com"));
